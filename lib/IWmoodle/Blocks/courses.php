...
function IWmoodle_coursesblock_display($row) {
    ...
    $exists = ModUtil::apiFunc('iw_main', 'user', 'userVarExists', array('name' => 'courses',
        'module' => 'IWmoodle',
        'uid' => $uid,
        'sv' => $sv));
    if ($exists) {
        $sv = ModUtil::func('iw_main', 'user', 'genSecurityValue');
        $s = ModUtil::func('iw_main', 'user', 'userGetVar', array('uid' => $uid,
            'name' => 'courses',
            'module' => 'IWmoodle',
            'sv' => $sv,
            'nult' => true));
    ...
    $sv = ModUtil::func('iw_main', 'user', 'genSecurityValue');
    ModUtil::func('iw_main', 'user', 'userSetVar', array('uid' => $uid,
        'name' => 'courses',
        'module' => 'IWmoodle',
        'sv' => $sv,
        'value' => $row['content'],
